    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.drivers.update", [$driver->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fullname') ? 'is-invalid' : '' }}" type="text" name="fullname" id="fullname" value="{{ old('fullname', $driver->fullname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_1') ? 'is-invalid' : '' }}" type="text" name="phone_1" id="phone_1" value="{{ old('phone_1', $driver->phone_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="text" name="password" id="password" value="{{ old('password', $driver->password) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_2') ? 'is-invalid' : '' }}" type="text" name="phone_2" id="phone_2" value="{{ old('phone_2', $driver->phone_2) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('routes') ? 'is-invalid' : '' }}" name="routes[]" id="routes" multiple>
                    @foreach($routes as $id => $route)
                        <option value="{{ $id }}" {{ (in_array($id, old('routes', [])) || $driver->routes->contains($id)) ? 'selected' : '' }}>{{ $route }}</option>
                    @endforeach
                </select>

...
@can('zone_vehicle_category_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'ZoneVehicleCategory', 'route' => 'admin.zone-vehicle-categories.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-ZoneVehicleCategory">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-ZoneVehicleCategory:not(.ajaxTable)').DataTable({ buttons: dtButtons })
